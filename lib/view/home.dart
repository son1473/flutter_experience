...
import 'package:flutterpartyquest/utils/location_utils.dart';
import 'package:flutterpartyquest/utils/map_controller.dart';
import 'package:flutterpartyquest/utils/marker.dart';
import 'package:flutterpartyquest/widgets/constants.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  //   controller.animateCamera(CameraUpdate.newCameraPosition(GetPosition().getLakePosition()));
  // }
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      body: GoogleMap(
        ...
        // onCameraMove: (
        //         (position) {
        //       MarkerFunction().updateMarkerPosition(position);
        //       setState(() {});
        //     }
        // ),
      ),
